...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", background: "#0f1117", color: "#e6edf3", display: "flex", flexDirection: "column" }}>
      ...
      {/* Footer */}
      <footer style={{ borderTop: "1px solid #1e2330", padding: "28px 40px", display: "flex", flexDirection: "column", gap: 10 }}>
        <p style={{ fontSize: 13, color: "#484f58", lineHeight: 1.65, maxWidth: 480 }}>
          Sentinel is an uptime monitoring tool that checks your URLs every 60 seconds and emails you the moment something goes down. Built as a personal project to keep an eye on my own live apps without relying on third-party dashboards.
        </p>
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: 8, paddingTop: 12, borderTop: "1px solid #1e2330" }}>
