...
export default function Home() {
  return (
    <div style={{ minHeight: "100vh", background: "#0f1117", color: "#e6edf3", display: "flex", flexDirection: "column" }}>
      ...
      {/* Footer */}
      <footer className="footer-pad" style={{ padding: "16px 40px", borderTop: "1px solid #1e2330", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 10 }}>
        <div style={{ display: "flex", gap: 18 }}>
          <a href="https://github.com/denzelchingodza/sentinel" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "#3d4450", textDecoration: "none" }}>GitHub</a>
          <a href="https://denzos-platform.vercel.app" target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, color: "#3d4450", textDecoration: "none" }}>DenzOS</a>
          <a href="mailto:denzel.chingodza@icloud.com" style={{ fontSize: 12, color: "#3d4450", textDecoration: "none" }}>Contact</a>
        </div>
        <span style={{ fontSize: 12, color: "#3d4450" }}>Built by Denzel Chingodza · 2026</span>
      </footer>
